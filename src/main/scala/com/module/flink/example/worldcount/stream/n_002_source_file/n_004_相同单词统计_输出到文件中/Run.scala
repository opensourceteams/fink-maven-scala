package com.module.flink.example.worldcount.stream.n_002_source_file.n_004_相同单词统计_输出到文件中
...
object Run {
  ...
  def main(args: Array[String]): Unit = {
    ...
    textResult.writeAsText("/opt/n_001_workspaces/bigdata/flink/flink-maven-scala/src/main/resources/dataoutput/a")
